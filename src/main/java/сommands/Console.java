...
public class Console {
    ...
    public void startInteractiveMode() {
        ...
        System.out.println("Доступные команды: [info, show, add, update, remove_by_id, clear, save, execute_script, exit, add_if_max, remove_greater, remove_lower, min_by_coordinates]");
