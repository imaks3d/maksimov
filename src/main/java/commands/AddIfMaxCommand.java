...
public class AddIfMaxCommand extends GenericCommand {
   ...
   public AddIfMaxCommand(PrintStream printStream, DataBase db, StudyGroupReader reader, UserStatusManager userStatusManager) {
      super(printStream);
      this.db = db;
      this.reader = reader;
   ...
   public String Description() {
      return " - add a StudyGroup in case it is maximum.";
   }
